...
public class OkGoHelper {
    private static final String TAG = "OkGoHelper";
    ...
    static void initExoOkHttpClient() {
        ...
        try {
            ...
            Log.e(TAG, "Error setting SSL for ExoPlayer client", th);
        }
    ...
    static void initDnsOverHttps() {
        ...
        try {
            ...
            Log.e(TAG, "Error setting SSL for DNS client", th);
        }
        builder.connectionSpecs(getConnectionSpec());
    ...
    public static void init() {
        ...
        try {
            ...
            Log.e(TAG, "Error setting SSL for main client", th);
        }
