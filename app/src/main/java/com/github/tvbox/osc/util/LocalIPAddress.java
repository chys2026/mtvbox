...
public class LocalIPAddress {
    ...
    public static String getLocalIPAddress(Context context) {
        ...
        if (ipAddress == 0) {
            try {
                ...
                Log.e("LocalIPAddress", "getLocalIPAddress SocketException", e);
            }
        } else {
    ...
    public static String getIP(Context context) {
        try {
            ...
            Log.e("LocalIPAddress", "getIP error", e);
            try {
                return getLocalIPAddress();
            } catch (Exception e1) {
                Log.e("LocalIPAddress", "getIP getLocalIPAddress error", e1);
            }
        }
        return "127.0.0.1";
    }
    ...
    public static String getLocalIPAddress() {
        try {
            ...
            Log.e("LocalIPAddress", "getLocalIPAddress SocketException", ex);
        }
        return "127.0.0.1";
    }
