                ...
                switch (msg.what) {
                    ...
                    case 1004: { // 设置速度
                        if (isInPlaybackState()) {
                            ...
                            Log.e(TAG, "Error setting speed in handler", e);
                        }
                    } else
    ...
    protected void initView() {
        ...
        mPlayerScaleBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.e(TAG, "Error setting screen scale", e);
            }
        }
    });
...
//        });
        mPlayerBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.e(TAG, "Error switching player type", e);
            }
        ...
        mPlayerBtn.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                try {
                    ...
                    Log.e(TAG, "Error in player select dialog", e);
                }
                mPlayerBtn.requestFocus();
                mPlayerBtn.requestFocusFromTouch();
                        }
                ...
                Log.e(TAG, "Error creating player select dialog", e);
            }
            return true;
            }
        });
        mPlayerIJKBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.e(TAG, "Error switching IJK codec", e);
            }
...
//        增加播放页面片头片尾时间重置
        mPlayerTimeResetBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e(TAG, "Error resetting player time", e);
            }
        }
    });
        mPlayerTimeStartBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Log.e(TAG, "Error setting time start", e);
                }
            }
        });
        mPlayerTimeStartBtn.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                try {
                    ...
                    Log.e(TAG, "Error resetting time start", e);
                }
                return true;
            }
        });
        mPlayerTimeSkipBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Log.e(TAG, "Error setting time skip", e);
                }
            }
        });
        mPlayerTimeSkipBtn.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                try {
                    ...
                    Log.e(TAG, "Error resetting time skip", e);
                }
                return true;
            }
        });
    ...
    void updatePlayerCfgView() {
        try {
            ...
            Log.e(TAG, "Error updating player config view", e);
        }
    }
    ...
    protected void setProgress(int duration, int position) {
        ...
        if (skipEnd && position != 0 && duration != 0) {
            ...
            try {
                ...
                Log.e(TAG, "Error reading et from player config", e);
            }
