...
public class JarLoader {
        ...
        try {
            ...
            do {
                try {
                    ...
                    Log.e("JarLoader", "loadClassLoader retry error", th);
                }
                count++;
            } while (count < 5);
            ...
            Log.e("JarLoader", "loadClassLoader error", th);
        }
        return success;
    }
    ...
    private DexClassLoader loadJarInternal(String jar, String md5, String key) {
        ...
        try {
            ...
            Log.e("JarLoader", "loadJarInternal error", e);
        }
        return null;
    }
...
//            }
            ...
            Log.e("JarLoader", "getSpider error", th);
        }
        return new SpiderNull();
    }
...
Method mth = jsonParserCls.getMethod("parse", LinkedHashMap.class, String.class);
            ...
            Log.e("JarLoader", "jsonExt error", th);
        }
        return null;
    }
    ...
    public JSONObject jsonExtMix(String flag, String key, String name, LinkedHashMap<String, HashMap<String, String>> jxs, String url) {
        try {
            ...
            Log.e("JarLoader", "jsonExtMix error", th);
        }
        return null;
    }
