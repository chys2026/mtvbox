...
public class SSLCompat extends SSLSocketFactory {
    ...
    static {
        try {
            ...
            Log.e("SSLCompat", "init cipher suites error", e);
        }
    }
    ...
    public SSLCompat() {
        try {
            ...
            Log.e("SSLCompat", "init SSL context error", e);
        }
    }
    ...
    public static final X509TrustManager TM = new X509TrustManager() {
        ...
        public void checkClientTrusted(X509Certificate[] chain, String authType) throws java.security.cert.CertificateException {
            if (chain == null || chain.length == 0) throw new java.security.cert.CertificateException("Client certificate chain is empty");
        }

        @Override
        public void checkServerTrusted(X509Certificate[] chain, String authType) throws java.security.cert.CertificateException {
            if (chain == null || chain.length == 0) throw new java.security.cert.CertificateException("Server certificate chain is empty");
