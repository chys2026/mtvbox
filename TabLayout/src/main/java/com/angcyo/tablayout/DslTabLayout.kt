...
open class DslTabLayout(
    ...
    init {
        ...
        tabConvexBackgroundDrawable =
            ContextCompat.getDrawable(context, typedArray.getResourceId(R.styleable.DslTabLayout_tab_convex_background, 0))
    ...
    class LayoutParams : FrameLayout.LayoutParams {
        ...
        constructor(c: Context, attrs: AttributeSet?) : super(c, attrs) {
            ...
            highlightDrawable =
                ContextCompat.getDrawable(context, a.getResourceId(R.styleable.DslTabLayout_Layout_layout_highlight_drawable, 0))
